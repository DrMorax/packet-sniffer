...
export function PacketViewer() {
  ...
  return (
    <div className="container mx-auto mt-8 max-w-5xl p-0">
      <Card className="h-full border-border p-0 shadow-sm">
        <CardHeader className="border-b bg-muted/50 p-4">
          ...
          <div className="flex items-center justify-between pt-4 pr-2 text-sm font-medium text-muted-foreground">
            <div className="w-1/4">Timestamp</div>
            <div className="w-2/4 text-center">Source &rarr; Destination</div>
            <div className="flex w-1/4 justify-end gap-12">
              <span>Flags</span> <span>Size</span>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-0">
          {packets.length > 0 ? (
            ...
            <h1 className="p-4 text-lg">No packets captured yet</h1>
          )}
        </CardContent>
      </Card>
    </div>
